...
import { hasUserLiked } from "@/lib/actions/like-actions";
...
export default function PostPage() {
    ...
    if (loading) {
        return <div className="text-center py-16 text-muted-foreground font-mono text-sm animate-pulse">Loading post...</div>;
    }

    if (!post) {
        return <div className="text-center py-16 text-muted-foreground font-light">Post not found.</div>;
    }
    ...
    return (
        ...
        >
            ...
            {/* Comments */}
            <motion.div variants={fadeInUp}>
                <h3 className="text-lg font-serif font-medium text-foreground mb-4">Discussion</h3>
